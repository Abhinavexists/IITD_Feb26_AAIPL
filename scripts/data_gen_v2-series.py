...
async def main():
    ...
    tasks = [generate_async(developer_prompt.format(topic=topics[2]), idx) for idx in range(1000)]
...
for i, r in enumerate(results):
    ...
    pd.DataFrame({'answer':final_output}).to_csv('Mixed_Series.csv',index=False)
